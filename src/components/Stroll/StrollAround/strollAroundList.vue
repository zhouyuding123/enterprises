    ...
    <div class="strollDiv">
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="我的帖子" name="second">
          ...
          <div>
            <div class="SetAs">
              <div class="Topping" @click="SetAsTopS"><span>设为置顶</span></div>
              <div class="Topping" @click="SetAsEssence"><span>设为精华</span></div>
            ...
            <div class="Mylist">
              ...
              >
                ...
                <vxe-column align="center">
                  <template v-slot="scoped">
                    <div class="setOneAs">
                    <div class="sz" @click="SetAsTop(scoped.row)"><span>设为置顶</span></div>
                    <div class="sz" @click="SetAsEssencer(scoped.row)"><span>设为精华</span></div>
                    <div class="sz" @click="DeletePost(scoped.row)"><span>删除帖子</span></div>
                  </div>
                  </template>
                </vxe-column>
              </vxe-table>
...
import { ForumListForumApi, CircleGetForumApi,ForumSetTopApi,ForumSetEssApi,ForumDelForumApi } from "../strollUrl.js";
...
export default {
  ...
  methods: {
    ...
    strollValue() {
      postD(ForumListForumApi()).then((res) => {
