...
var routes = [{
  ...
  children: [{
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../components/capital/capitals.vue"));
      });
    },
    meta: {
      title: "钱包",
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/capital/capitalVal/capital.vue"));
        });
      },
      meta: {
        title: "钱包管理",
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/capital/capitalVal/addcard.vue"));
        });
      },
      meta: {
        title: "银行卡",
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../components/Storearea/StoreArea.vue"));
      });
    },
    meta: {
      title: "门店专区"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/Storearea/StoreAreaList/StoreAreaList.vue"));
        });
      },
      meta: {
        title: "门店列表"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/EventManagement/EventList/listFlag/detial/detialtwo.vue"));
        });
      },
      meta: {
        title: "我的赛事详情"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/Preorderlist/PreorderList.vue"));
        });
      },
      meta: {
        title: "预购列表"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/designer/free/freeDetil/myDetil/myDetil.vue"));
        });
      },
      meta: {
        title: "设计师信息"
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/designer/addVip/addVip.vue"));
        });
      },
      meta: {
        title: "会员"
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../components/Platfrom/listPlatfrom.vue"));
      });
    },
    meta: {
      title: "官方赛事"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/Platfrom/PlatformEvents/oder/addOder.vue"));
        });
      },
      meta: {
        title: "发起预购"
    ...
    component: function component() {
      return Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../components/Enterprisecertification/Enterprisecertification.vue"));
      });
    },
    meta: {
      title: "企业管理"
    ...
    children: [{
      ...
      component: function component() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require("../components/Enterprisecertification/Enterprisecertificationval/Enterprisecertificationval.vue"));
        });
      },
      meta: {
        title: "企业认证"
  ...
  component: function component() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require("../views/vip.vue"));
    });
  }
}];
